...
const (
	...
	MsgRedemptionNameInvalidChars  = "redemption.name_invalid_chars"
...
const (
	...
	MsgUserAffCodeGenerateFailed     = "user.aff_code_generate_failed"
...
const (
	...
	MsgTicketInvoiceRemarkTooLong       = "ticket.invoice_remark_too_long"
