...
export function isGeneratedTicketSummary(content, ticketType) {
...
export function extractRemarkFromSummary(content) {
  ...
  return content
    .slice(separatorIndex + TICKET_REMARK_SEPARATOR.length)
    .trim();
}
