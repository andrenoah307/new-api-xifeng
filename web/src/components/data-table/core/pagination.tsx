...
type DataTablePaginationProps<TData> = {
  table: Table<TData>
  /**
   * Raw total row count from the API. When the backend caps the count
   * (multiples of 1000 from the cached-total path), a "+" suffix is shown.
   */
  totalRows?: number
}
...
export function DataTablePagination<TData>({
  ...
  const totalRows = totalRowsProp ?? table.getRowCount()
  const isCapped =
    totalRowsProp != null && totalRowsProp > 0 && totalRowsProp % 1000 === 0
