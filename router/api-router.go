...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/rankings", middleware.HeaderNavModuleAuth("rankings"), middleware.AdminAuth(), controller.GetRankings)
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.GET("/rate-limit-stats", controller.GetChannelRateLimitStats)
		...
		dataRoute.GET("/flow/self", middleware.UserAuth(), middleware.DashboardDataRateLimit(), controller.GetUserFlowQuotaDates)
