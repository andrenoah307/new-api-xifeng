...
func TestPressureCoolingRuntimeRouteUsesReadPermission(t *testing.T) {
	assertChannelRoutePermission(t, http.MethodGet, "/pressure_cooling/runtime", authz.ChannelRead, controller.GetPressureCoolingRuntime)
}
