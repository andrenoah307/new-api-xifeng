...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodGet, path: "/:id/inflight", permission: authz.ChannelRead, handler: controller.GetChannelInflight},
	{method: http.MethodPost, path: "/:id/inflight/cleanup", permission: authz.ChannelOperate, handler: controller.CleanupChannelInflight},
