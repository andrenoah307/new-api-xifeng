...
func SetVideoRouter(router *gin.Engine) {
	...
	videoProxyRouter.Use(middleware.RelayAdmission())
	{
	...
	videoV1Router.Use(middleware.RelayAdmission())
	...
	klingV1Router.Use(middleware.RelayAdmission())
	...
	jimengOfficialGroup.Use(middleware.RelayAdmission())
